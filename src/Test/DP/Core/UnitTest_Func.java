...
public class UnitTest_Func
{
  ...
  {
    Function<double[], Double> square = (double[] arr) -> arr[0] * arr[0];
    if (square.apply(new double[]{2}) != 4) throw new AssertionError();
    ...
    System.out.println(newFunc.apply(JNum.ones(2)));
  }
